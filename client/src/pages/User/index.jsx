  ...
  return (
    <>
      <div className={styles["container"]}>
        ...
        { showForm ? <div className={styles['form-input']}>
          <select multiple id="role" value={role} onChange={handleRChange} >
            <option value="Choose">Choose your role</option>
            <option value="Developer">Developer</option>
            <option value="Designer">Designer</option>
          </select>
          <input type="text" value={role} disabled /></div> : <p>{data.role ? data.role : 'no role yet'}</p>}
